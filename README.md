# FormFusion - Basic connect usage

This repository contains a simple example of using the connect function from the FormFusion [library](https://www.corelabui.com/)
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/corelabui/basic-connect-usage.git
   ```

2. Install dependencies:

   ```bash
   cd basic-connect-usage
   npm install
   ```
